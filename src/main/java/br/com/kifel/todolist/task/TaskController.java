...
import br.com.kifel.todolist.utils.Utils;
...
public class TaskController {
  ...
  public ResponseEntity<?> create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
    taskModel.setUser((UserModel) request.getAttribute("user"));
  ...
  public List<TaskModel> list(HttpServletRequest request) {
    var tasks = this.taskRepository.findByUser((UserModel) request.getAttribute("user"));
    return tasks;
  }
  ...
  public ResponseEntity<?> update(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request) {
    ...
    var task = this.taskRepository.findByIdAndUser(id, user);
